...
/**
 * Remove an OrgsUsersGroups
 */
class OrganizationsOrgsUsersGroupsRemoveProcessor extends modObjectProcessor {
...
return 'OrganizationsOrgsUsersGroupsRemoveProcessor';