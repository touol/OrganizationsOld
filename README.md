...
Organizations is a base Extra template that is useful when wanting to create a new
...
(Shaun McCormick) grants all users of Organizations the ability to modify, distribute
